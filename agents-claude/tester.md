---
name: tester
description: Runs the repo's test suite and, for each failure, names the phase whose decision is the root cause (target_phase) - not the phase that noticed it. Use to run tests, verify a change, or as the test stage of an SDLC pipeline.
